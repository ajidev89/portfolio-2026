...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <section className="min-h-[90vh] flex flex-col justify-center px-6 pt-32 max-w-6xl mx-auto">
        ...
        >
          <div className="max-w-3xl order-2 md:order-1">
            <motion.div
              variants={fadeUp}
              className="font-mono text-accent-gradient text-sm mb-6 tracking-tight"
            >
              AJIDAGBA AYOBAMI
            </motion.div>
            <motion.h1
              variants={fadeUp}
              className="text-5xl sm:text-7xl font-bold tracking-tight text-foreground leading-[1.1] mb-8"
            >
              Principal Engineer.
              <br />
            ...
            >
              Product-first engineer building APIs, web, and mobile products
              across fintech, e-commerce, ERP, logistics, and digital agencies.
              I lead teams from initial planning through rollout — and beyond
              expectations.
            </motion.p>
            <motion.div
              variants={fadeUp}
          ...
          >
            <div className="relative">
              ...
              />
              <div
                className="absolute -inset-px rounded-full bg-gradient-to-br from-primary/60 via-primary/10 to-transparent"
                aria-hidden="true"
              />
              <img
                src={profileImage}
      ...
      <section
        id="about"
        className="py-32 px-6 max-w-5xl mx-auto border-t border-border"
      >
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          <motion.h2
            variants={fadeUp}
            className="text-3xl font-bold flex items-baseline gap-4"
          >
            <span className="text-accent-gradient font-mono text-sm font-normal">
              01.
            </span>{" "}
            About
          </motion.h2>
          <div className="md:col-span-2 space-y-6 text-muted-foreground leading-relaxed text-lg">
            <motion.p variants={fadeUp}>
              I'm a solutions-driven engineer with hands-on experience across
              finance, e-commerce, enterprise resource planning, logistics, and
              digital agencies — building both web and mobile products
              end-to-end.
            </motion.p>
            <motion.p variants={fadeUp}>
              I've taken products from initial planning through full rollout and
              ongoing support, and I've led teams of developers — assigning work
              by individual strength and shipping past company expectations.
            </motion.p>
            <motion.p variants={fadeUp}>
      ...
      >
        ...
        >
          <motion.h2
            variants={fadeUp}
            className="text-3xl font-bold mb-16 flex items-baseline gap-4"
          >
            <span className="text-accent-gradient font-mono text-sm font-normal">
              02.
            </span>{" "}
      ...
      >
        ...
        >
          <motion.h2
            variants={fadeUp}
            className="text-3xl font-bold mb-6 flex items-baseline gap-4"
          >
            <span className="text-accent-gradient font-mono text-sm font-normal">
              03.
            </span>{" "}
          ...
          >
            The everyday stack — battle-tested across fintech, ERP, e-commerce,
            and logistics.
          </motion.p>
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            className="text-muted-foreground text-lg max-w-2xl mb-16 leading-relaxed"
          >
            Brands I've shipped for — fintech rails, marketplaces, and revenue
            products.
          </motion.p>
            ...
            {projects.map((project, i) => (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <div className="font-mono text-accent-gradient text-sm">
                    {project.category}
                  </div>
      ...
      <section
        id="contact"
        className="py-32 px-6 max-w-2xl mx-auto text-center border-t border-border"
      >
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          <motion.div
            variants={fadeUp}
            className="font-mono text-accent-gradient text-sm mb-4"
          >
            05. What's Next?
          </motion.div>
          ...
          >
            I'm open to contract and full-time roles where backend depth,
            product thinking, and shipping discipline matter. Whether you're
            scoping an ERP, a payments rail, or a marketplace — let's talk.
          </motion.p>
          <motion.a
            variants={fadeUp}
